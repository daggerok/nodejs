...
let Rectangle = require(path.join(__dirname, '..', '..', 'src', 'modules', 'Rectangle'))
...
describe('Another Rectangle', () => {
  describe('constructor', () => {
    it('requires two numerical arguments', () => {
      ...
      // ';' is required here! we are using a few anonymous arrow fuctions in same `it()`, so we must seporate them after throw instructions somehow...
